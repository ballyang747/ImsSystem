...
$(function(){
	...
	$("#bindPopedom").click(function(){
		...
		window.location = "${ctx}/identity/popedom/bindPopedom.jspx?id=${role.id}&code=${module.code}&name=${module.name}&codes="+arr
	});
	...
	$.each(boxes,function(){
		if("${roleModuleOperasCodes}".indexOf(this.value) != -1){
			//触发 checkbox的 click以及mouseover事件   ，这些时间在   operaPageCss.js文件中已经实现

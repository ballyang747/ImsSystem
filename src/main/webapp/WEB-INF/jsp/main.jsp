...
<body>
    <div class="container">
           ...
           <div class="pf-logo"">
            ...
            <div class="pf-user">
                <div class="pf-user-photo">
                    <img style="width: 40px;height: 40px;" src="${ctx}/images/main/user.png" alt="">
                </div>
       ...
       <%--            	  	    <c:forEach items="${userPopedomModules}" var="userModule">
                  	  	   ...
                  	  	   <c:forEach items="${mapModules}"  var="map">
                  	  	<li>
		                  	  	    <a href="javascript:;" >
			                            <span class="iconfont sider-nav-icon">&#xe611;</span>
	                        ...
	                        <ul class="sider-nav-s">
			                          <c:forEach items="${map.value}"  var="module">
			                        		 <li><a href="javascript:addPanel('${module.code}' ,'${module.url}?pCode=${module.code}','${module.name}');">${module.name}</a></li>
			                          </c:forEach>

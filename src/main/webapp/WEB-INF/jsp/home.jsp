...
<head> 
	...
	$(function(){
		...
		$("#btn_submit").click(function(){
			...
			$.post("${ctx}/identity/user/updateSelf.jspx",
        				 $("#updateSelfForm").serialize(),
        				 function(msg1,status){
        			         ...
        			         if(status=="success"&& msg1=="ok"){
        			        	  ...
        			        	  sessionStorage.setItem("msg","修改信息成功");
        			   
        			        	  top.location.reload();
                              }else if(status=="success"&& msg1=="fail"){
                            	  sessionStorage.setItem("msg","修改信息失败");
	      ...
	      <div class="row info-content">
		 	<form id="updateSelfForm" class="form-horizontal" method="post" action="${ctx }/identity/user/updateSelf.jspx"  style="margin-top: 20px;">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input id="tel" name="tel" type="text" value="${session_user.tel}" class="form-control" placeholder="请输入您的电子邮件">
					</div>
